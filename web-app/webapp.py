...
def search_weburl():
    for files in glob.glob("./static/images/retrieved_images/*.jpg"):
        os.unlink(files)
    ...
    for image_detail in image_details:
        ...
        classes = verify_guidelines.ExtractClasses(
            image_details[image_detail]["src"],
            image_details[image_detail]["alt"],
            image_details[image_detail]["vicinity_text"])
        data_dictionary.append(
            {"imageinfo": image_details, "classes": classes})
